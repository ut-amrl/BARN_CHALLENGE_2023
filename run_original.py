...
if __name__ == "__main__":
    ...
    # bash_file = '/home/zichao/catkin_ws/src/BARNSubmission/vagn/evaluator.sh'
    ...
    while curr_coor[1] < 10.5 and not collided and curr_time - start_time < 100:
        curr_time = rospy.get_time()
        pos = gazebo_sim.get_model_state().pose.position
        curr_coor = (pos.x, pos.y)
